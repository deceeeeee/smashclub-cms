...
const FieldBookingReport = () => {
    const [year] = useState('2023');

    return (
        <div className="report-page field-booking-report">
            {/* Breadcrumbs */}
            ...
            <div className="report-header">
                <div className="header-text">
                    <h1>Laporan Pemesanan Lapangan</h1>
...
export default FieldBookingReport;
